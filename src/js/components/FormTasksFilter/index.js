...
export const FormName = 'taskFiltersForm';

@withStyles(styles)
@TasksContainer({ fetchTaskAuthorities: true, params: { issuedTasks: false } })
@injectIntl
@reduxForm({
    form: FormName,
...
class FormTasksFilter extends Component<Props, State> {
    onSubmit = () => {
        ...
        return (
            ...
            >
                ...
                <Collapsable
                    nullOnHidden={false}
                    classes={classes}
                    title={intl.formatMessage(messages.assignedBy)}
                    isOpen
                >
                    {isLoadingTaskAuthorities ? (
                ...
                <Field name="tags" component={renderHiddenField} />
            </Form>
        );
    }
}
export default FormTasksFilter;
