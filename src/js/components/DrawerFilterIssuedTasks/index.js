...
import FormTasksIssuedFilter, {
    FormName as FiltersFormName
} from 'components/FormTasksIssuedFilter';
...
const DrawerFilterIssuedTasks = (props: Props) => {
...
}))(injectIntl(DrawerFilterIssuedTasks));
