...
class SubmitRequestCertification extends Component<Props, State> {
    ...
    uploadDocuments = (values: {
        ...
        const files = _.get(values, 'documents.uploadedFiles', []);
    ...
    copyExistingDocuments = (values: {
        ...
        const nodeRefs = _.get(values, 'documents.selectedFiles', []);
    ...
    handleFinish = (args: StepperProps) => {
        ...
        log('cert finish', 'blue', { args, forms, createRequest, router });
        ...
        showMessage({ message: 'assigningCertificate', variant: 'pending' });
        ...
        this.copyExistingDocuments(fieldValues)
            .then(r => {
                const existingNodeRefs = _.get(
                    r,
                    'action.payload.data.nodeRefs',
                    []
                );
                ...
                this.uploadDocuments(fieldValues)
                    ...
                    .then(() => {
                        ...
                        showMessage({
                            message: 'assigningCertificateSuccess',
                            variant: 'success'
                        });
                        return null;
                    })
...
export default SubmitRequestCertification;
