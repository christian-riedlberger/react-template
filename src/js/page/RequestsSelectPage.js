...
// Local
import LayoutRequestsSelect from 'components/LayoutRequestsSelect';
...
@secretCheck
@verifiedCheck
class RequestsSelectPage extends Component<Props> {
    render() {
...
export default hot(reloadable(injectIntl(RequestsSelectPage)));
