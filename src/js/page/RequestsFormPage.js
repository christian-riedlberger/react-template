...
// Local
import LayoutRequestForm from 'components/LayoutRequestForm';
...
@secretCheck
@verifiedCheck
class RequestsFormPage extends Component<Props> {
    render() {
...
export default hot(reloadable(injectIntl(RequestsFormPage)));
