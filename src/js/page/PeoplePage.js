...
// Local
import LayoutPeople from 'components/LayoutPeople';
...
@secretCheck
@verifiedCheck
class PeoplePage extends Component<Props> {
    render() {
            ...
            <App>
                ...
                <PageAccess page="people">
                    <div className="page-wrapper">
                        <LayoutPeople startIndex={startIndex} />
                    </div>
                </PageAccess>
            </App>
        );
...
export default hot(reloadable(injectIntl(PeoplePage)));
